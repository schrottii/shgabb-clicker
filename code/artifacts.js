...
var artifacts = [
	...
	new Artifact(222, 2, "Amulet of Quickgemming", "amulet.png", "gemchance", level => 1.2 + 0.2 * level, { trigger: () => clickCooldown == 0.1, desc: "If the click cooldown is 0.1s" }),
	new Artifact(223, 2, "Amulet of Gem Mines", "amulet.png", "gemchance", level => 1.2 * level, { trigger: () => game.gems < 200, desc: "If owning less than 200 Gems" }),
