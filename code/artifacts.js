...
var artifacts = [
	...
	new Artifact(206, 2, "Amulet of Passive Silicone", "amulet.png", "si", 1.6, { prefix: "x", trigger: () => game.clickCooldown < 0, desc: "When not clicking" }),
	new Artifact(207, 2, "Amulet of Active Silicone", "amulet.png", "si", 2.5, { prefix: "x", trigger: () => game.clickCooldown > 0, desc: "When the click cooldown is active" }),
	new Artifact(208, 2, "Amulet of Fast Start", "amulet.png", "shgabb", 3, { prefix: "x", trigger: () => game.stats.pttp < 180, desc: "For 3 minutes after a prestige" }),
	new Artifact(209, 2, "Amulet of Tides", "amulet.png", "shgabb", 3, { prefix: "x", trigger: () => game.stats.pttp % 20 >= 10, desc: "Active for 10 seconds, inactive for 10 seconds" }),
