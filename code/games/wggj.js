...
function wggjLoop() {
    ...
    if (window.innerWidth <= 480) {
        // mobile
        wggjCanvas.style.width = (wggjCanvasWidth = wggjCanvas.width = window.innerWidth * 0.96) + "px";
        wggjCanvas.style.height = (wggjCanvasHeight = wggjCanvas.height = window.innerWidth * 0.96 / 1.7777777777777777777777777777778) + "px";
    }
    else {
        // PC
        wggjCanvas.style.width = (wggjCanvasWidth = wggjCanvas.width = window.innerWidth * 0.8) + "px";
        wggjCanvas.style.height = (wggjCanvasHeight = wggjCanvas.height = window.innerWidth * 0.8 / 1.7777777777777777777777777777778) + "px";
    }

    wggjTextScaling = 0.42 * (Math.pow(wggjCanvasWidth, 0.9) / 244);
