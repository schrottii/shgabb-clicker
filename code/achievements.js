...
var achievements = [
    ...
    new Achievement(108, "bags.png", "Playing DaGame IV", () => "Get " + fn(1000000) + " Bags (total)", () => game.stats.bags >= 1000000),
    ...
    new Achievement(109, "bags.png", "Playing DaGame V", () => "Get " + fn(16000000) + " Bags (total)", () => game.stats.bags >= 16000000),
