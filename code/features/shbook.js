...
const featuriary = [
    ...
    new BookEntry(2, "Unlocks", () => true, "...", "There are many features, currencies and other things that can be unlocked in this game. Most of them are unlocked by upgrading the first Shgabb Upgrade, called More Shgabb. Its unlocks often refer to it as HMS. Below you can find a list of ALL HMS unlocks, beware of the spoilers. Some things are unlocked in other ways, but they are easy to come across. Hope you enjoy unlocking new content! <br /> <br /><div style='text-align: left'>- HMS 25: Shbook<br />- HMS 100: Player Profile<br />- HMS 500: Gems<br />- HMS 1000: Artifacts<br />- HMS 2000: Events, Améliorer and Minigames (Shgic Shgac Shgoe)<br />- HMS 4000: Lore<br />- HMS 5000: Chengas<br />- HMS 6000: Challenges<br />- HMS 8000: Bags<br />- HMS 10000: Copper Shgabb<br />- HMS 12000: Fishgang</div>"),
    new BookEntry(3, "Prestige", () => unlockedGS(), "1M Shgabb", "Prestiging is unlocked at 1M Shgabb. Prestiging sacrifices most progress, such as Shgabb, Sandwiches and Upgrades, but gives Golden Shgabb in return."),
    new BookEntry(4, "Artifacts", () => unlockedArtifacts(), "HMS 1000", "Artifacts are unlocked at HMS 1000 and can be equipped for all kinds of effects, from simple to mind-blowing complicated. By default, up to 3 Artifacts can be equipped at the same time. Artifacts of the same type are multiplicative with each other. Artifacts can be found from clicking or bought with Gems, and the further you go, the more Artifacts you can find. Loadouts can be saved and loaded at any time."),
    new BookEntry(5, "Shgic Shgac Shgoe", () => unlockedAmeliorer(), "HMS 2000", "Shgic Shgac Shgoe (whatever that means) is unlocked along Améliorer. Every day you get the chance to win 2 Améliorer here by playing your cards right."),
    new BookEntry(6, "Challenges", () => unlockedChallenges(), "HMS 6000", "Challenges are unlocked at HMS 6000 and each offer a change to the gameplay. Starting a Challenge costs Gems and a Prestige. A Challenge can be beaten by reaching the required More Shgabb amount and then performing a Prestige. Each Challenge has a different reward, increasing with every tier: with every completion."),
    new BookEntry(7, "Fishgang", () => unlockedFishing(), "HMS 12 000", "Fishgang (also known as Fishing) is the second minigame, unlocked at HMS 12000. It is rather complex. The player can choose how far to throw the rod, further distances are more difficult, but also more valuable. The player can catch trash or fish, which award XP that contribute to level ups which award Pearls."),
];
