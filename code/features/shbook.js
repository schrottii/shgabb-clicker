...
const currenciary = [
    ...
    new BookEntry(11, "Etenvs", () => unlockedEtenvs(), "HMS 10 000", "Etenvs are the fifth side currency, unlocked at HMS 10 000. Every event you play, you get one Etenv. In the Events section of the Shbook, you can spend one Etenv and 10 000 Gems to summon an Event for 24 hours!"),
    new BookEntry(12, "Pearls", () => unlockedFishing(), "HMS 12 000", "Pearls are the fourth side currency, earned from Fishgang level ups. They can be spent on minor boosts. It is possible to reset and refund all Pearls every new level up."),
