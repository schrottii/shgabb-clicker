...
const featuriary = [
    ...
    new BookEntry(6, "Artifacts", () => unlockedArtifacts(), "HMS 1000", "Artifacts are unlocked at HMS 1000 and can be equipped for all kinds of effects, from simple to mind-blowing complicated. By default, up to 3 Artifacts can be equipped at the same time. Artifacts of the same type are multiplicative with each other. Artifacts can be found from clicking or bought with Gems, and the further you go, the more Artifacts you can find. Loadouts can be saved and loaded at any time.<br />Tiers:<br /><div style='text-align: left'>- Tier I: 1000<br />- Tier II: 2000<br />- Tier III: 4000<br />- Tier IV: 8000<br />- Tier V: 10,000"),
