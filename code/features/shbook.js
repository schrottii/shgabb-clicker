...
const featuriary = [
    ...
    new BookEntry(8, "Fishgang", () => unlockedFishing(), "HMS 5 000", "Fishgang (also known as Fishing) is the second minigame, unlocked at HMS 5000. It is rather complex. The player can choose how far to throw the rod, further distances are more difficult, but also more valuable. The player can catch trash or fish, which award XP that contribute to level ups which award Pearls."),
    new BookEntry(9, "Challenges", () => unlockedChallenges(), "HMS 6000", "Challenges are unlocked at HMS 6000 and each offer a change to the gameplay. Starting a Challenge costs Gems and a Prestige. A Challenge can be beaten by reaching the required More Shgabb amount and then performing a Prestige. Each Challenge has a different reward, increasing with every tier: with every completion."),
    new BookEntry(10, "The Mine", () => unlockedMine(), "HMS 12 000", "The Mine is the third minigame, unlocked at HMS 12 000. Walk through randomly generated mines (arrow keys (space to stop moving) or clicking the arrows). You can come across Golden Shgabb, Silicone and Copper. Stand on an ore to mine it. Make progress with the normal click button, or auto. There are walls and water you can't walk through. And webs, which slow you down for 2 seconds."),
];
