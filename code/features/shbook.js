...
const currenciary = [
    ...
    new BookEntry(8, "Pearls", () => unlockedFishing(), "HMS 5000", "Pearls are the fourth side currency, earned from Fishgang level ups. They can be spent on minor boosts. It is possible to reset and refund all Pearls every new level up."),
    new BookEntry(9, "Chengas", () => unlockedChengas(), "HMS 7000", "Chengas are the third side currency. They can be used to change the ad boost that's being offered. Doing so consumes 1 Chenga, and then the offer does not expire, and can be changed infinite times without consuming more. There is a 10% chance to get a Chenga after watching any ad."),
    new BookEntry(10, "Bags", () => unlockedBags(), "HMS 8000", "Bags are the sixth main currency, unlocked at HMS 8000, and can be earned from upgrading More Shgabb. They can be spent on a collection of upgrades."),
    new BookEntry(11, "Copper Shgabb", () => unlockedCopper(), "HMS 10 000", "Copper is the seventh main currency, unlocked at HMS 10 000. It can be earned by clicking, starting with a 1% chance. Its value inflates quickly."),
    new BookEntry(12, "Etenvs", () => unlockedEtenvs(), "HMS 10 000", "Etenvs are the fifth side currency, unlocked at HMS 10 000. Every event you play, you get one Etenv. In the Events section of the Shbook, you can spend one Etenv and 10 000 Gems to summon an Event for 24 hours!"),
    new BookEntry(13, "Iron Shgabb", () => unlockedMine(), "HMS 12 000", "Iron is unlocked at HMS 12 000, alongside The Mine. It can be found like other ores, but takes longer to mine. Mining it rewards 1 Iron, which can be spent on four upgrades, shown below the minigame."),
    new BookEntry(14, "Bananas", () => unlockedBananas(), "HMS 15 000", "Bananas are the eighth main currency. Seeds can be found from Prestiges (more time -> higher chance, min. 1 minute, max. 15 minutes) and used to plant Banana Trees. Every click can make the trees grow Bananas. Every day where you log in, the trees get older, making them generate more Bananas per click, but also easier to break. You need to collect the Bananas from the trees, which has a chance of destroying the tree. Bananas can be spent on upgrades."),
];
...
const featuriary = [
    ...
    new BookEntry(2, "Unlocks", () => true, "...", "There are many features, currencies and other things that can be unlocked in this game. Most of them are unlocked by upgrading the first Shgabb Upgrade, called More Shgabb. Its unlocks often refer to it as HMS. Below you can find a list of ALL HMS unlocks, beware of the spoilers. Some things are unlocked in other ways, but they are easy to come across. Hope you enjoy unlocking new content! <br /> <br /><div style='text-align: left'>- HMS 25: Shbook<br />- HMS 100: Player Profile<br />- HMS 500: Gems<br />- HMS 1000: Artifacts<br />- HMS 2000: Events, Améliorer and Minigames (Shgic Shgac Shgoe)<br />- HMS 4000: Lore<br />- HMS 5000: Fishgang<br />- HMS 6000: Challenges<br />- HMS 7000: Chengas<br />- HMS 8000: Bags<br />- HMS 10000: Copper Shgabb<br />- HMS 12000: The Mine<br />- HMS 15000: Bananas</div>"),
    ...
    new BookEntry(6, "Shgic Shgac Shgoe", () => unlockedAmeliorer(), "HMS 2000", "Shgic Shgac Shgoe (whatever that means) is unlocked along Améliorer. Every day you get the chance to win 2 Améliorer here by playing your cards right. Get 3 in a row to win, classic rules. The first one to get 3 wins/points wins. You can play once per day, and after you win or lose, you have to wait until the next day to play again. It is an infinite source of Améliorer."),
    new BookEntry(7, "Fishgang", () => unlockedFishing(), "HMS 5 000", "Fishgang (also known as Fishing) is the second minigame, unlocked at HMS 5000. It is rather complex. The player can choose how far to throw the rod, further distances are more difficult, but also more valuable. The player can catch trash or fish, which award XP that contribute to level ups which award Pearls."),
    new BookEntry(8, "Challenges", () => unlockedChallenges(), "HMS 6000", "Challenges are unlocked at HMS 6000 and each offer a change to the gameplay. Starting a Challenge costs Gems and a Prestige. A Challenge can be beaten by reaching the required More Shgabb amount and then performing a Prestige. Each Challenge has a different reward, increasing with every tier: with every completion."),
    new BookEntry(9, "The Mine", () => unlockedMine(), "HMS 12 000", "The Mine is the third minigame, unlocked at HMS 12 000. Walk through randomly generated mines (arrow keys (space to stop moving) or clicking the arrows). You can come across Golden Shgabb, Silicone and Copper. Stand on an ore to mine it. Make progress with the normal click button, or auto. There are walls and water you can't walk through. And webs, which slow you down for 2 seconds."),
];
