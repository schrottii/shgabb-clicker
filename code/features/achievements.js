...
var achievements = [
    ...
    new Achievement(224, "generators.png", "Cheap EV", "Buy the first Generator (^0.1 boost)", () => game.generators[0][0] >= 1),
    new Achievement(225, "generators.png", "As all things should be", "Buy the second Generator (^0.2 boost)", () => game.generators[1][0] >= 1),
    new Achievement(226, "generators.png", "Boosting the Generators", "Buy the third Generator (^0.3 boost)", () => game.generators[2][0] >= 1),
    new Achievement(227, "generators.png", "Weak as ever", "Buy the fourth Generator (^0.4 boost)", () => game.generators[3][0] >= 1),
    new Achievement(228, "generators.png", "Idle Bar", "Buy the fifth Generator (^0.5 boost)", () => game.generators[4][0] >= 1),
    ...
    new Achievement(232, "arti.png", "Scrap You I", "Destroy 10 Artifacts", () => game.stats.artisDestroyed >= 10),
    new Achievement(233, "arti.png", "Scrap You II", "Destroy 100 Artifacts", () => game.stats.artisDestroyed >= 100),
    new Achievement(234, "arti.png", "Scrap You III", "Destroy 1000 Artifacts", () => game.stats.artisDestroyed >= 1000),
    new Achievement(235, "arti.png", "Scrap You IV", "Destroy 10,000 Artifacts", () => game.stats.artisDestroyed >= 10000),
    new Achievement(236, "arti.png", "Scrap You V", "Destroy a million Artifacts", () => game.stats.artisDestroyed >= 1e6),
    new Achievement(237, "arti.png", "Destructive Breakdown", "Destroy more Artis than you get in one day, at least 50", () => game.stats_today.artisDestroyed > game.stats_today.artisFound && game.stats_today.artisDestroyed >= 50),
    new Achievement(33, "hms.png", "Shgabb Conqueror III", "Reach More Shgabb level 5000", () => game.stats.hms >= 5000),

    new Achievement(156, "unlock.png", "The Ads Are Changing", "Unlock Chengas by reaching HMS 5000", () => unlockedChengas()),
    ...
    new Achievement(90, "unlock.png", "Challenge Me!", "Unlock Challenges by reaching HMS 4000", () => unlockedChallenges()),
    ...
    new Achievement(216, "artifact.png", "My big collection", "Get your 80th Artifact", () => getArtifactAmount() >= 80),
    ...
    new Achievement(166, "unlock.png", "Wet Gang", "Unlock Fishgang by reaching HMS 12000", () => unlockedFishing()),
