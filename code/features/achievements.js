...
var achievements = [
    ...
    new Achievement(16, "unlock.png", "Do we have dinosaurs???", "Unlock Artifacts by reaching HMS 1000", () => unlockedArtifacts()),
    ...
    new Achievement(125, "shbook.png", "Luckily it's in English", "Find a lore page", () => game.lore.length > 0),
    ...
    // new Achievement(x, "achievement.png", "Achiever V", "Get 150 Achievements", () => game.ach.length >= 150),
